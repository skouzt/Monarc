...
const state: Monarc.Store.State = {
  tabId: 0,
  tabs: [],
  tabsOrder: [],
  currentTabIndexes: [0],
...
function createTabObject(stateContext: Monarc.Store.State, wid: number, openUrl: string | null = null): Monarc.Store.TabObject {
  return {
    browserViewId: -1,
    webContentsId: -1,
    id: 0,
...
const mutations = {
  // global counter
  [types.INCREMENT_TAB_ID](stateContext: Monarc.Store.State): void {
    stateContext.tabId += 1;
  },
  // tab handler
  [types.CREATE_TAB](stateContext: Monarc.Store.State, payload: any): void {
  ...
  [types.CLOSE_TAB](stateContext: Monarc.Store.State, payload: any): void {
    const windowId: number = payload.windowId;
    ...
    if (tabs.length > tabIndex) {
      ...
      if (tabs.length === 1) {
        ...
        // eslint-disable-next-line max-len
        const tabsMapping = (mappedTabs: Monarc.Store.TabObject[], tabsOrder: number[]): number[] => {
  ...
  [types.CLOSE_ALL_TABS](stateContext: Monarc.Store.State, payload: any): void {
    const windowId: number = payload.windowId;
  ...
  [types.CLICK_TAB](stateContext: Monarc.Store.State, payload: any): void {
    const windowId: number = payload.windowId;
    const tabId: number = payload.tabId;
    const tabIndex: number = payload.tabIndex;
  ...
  // tab handlers
  [types.SET_BROWSER_VIEW_ID](stateContext: Monarc.Store.State, payload: any): void {
  ...
  [types.DID_START_LOADING](stateContext: Monarc.Store.State, payload: any): void {
    // const windowId: number = payload.windowId;
  ...
  [types.DID_NAVIGATE](stateContext: Monarc.Store.State, payload: any): void {
    // const windowId: number = payload.windowId;
    const tabId: number = payload.tabId;
    // const tabIndex: number = payload.tabIndex;
    const url: string = payload.url;
  ...
  [types.PAGE_TITLE_UPDATED](stateContext: Monarc.Store.State, payload: any): void {
    // const windowId: number = payload.windowId;
    const tabId: number = payload.tabId;
    // const tabIndex: number = payload.tabIndex;
  ...
  [types.DOM_READY](stateContext: Monarc.Store.State, payload: any): void {
    // const windowId: number = payload.windowId;
    const tabId: number = payload.tabId;
    // const tabIndex: number = payload.tabIndex;
  ...
  [types.DID_FRAME_FINISH_LOAD](stateContext: Monarc.Store.State, payload: any): void {
    // const windowId: number = payload.windowId;
    const tabId: number = payload.tabId;
    // const tabIndex: number = payload.tabIndex;
    const url: string = payload.url;
    const regexp = new RegExp(/^Monarc(-extension)?:\/\/.+$/);
    ...
    if (stateContext.tabs[tabsIndex] && url) {
      if (stateContext.tabs[tabsIndex].title !== 'error') {
        ...
        if (url === 'chrome://gpu/') {
          ...
          stateContext.tabs[tabsIndex].favIconUrl = constants.tabConfig.MonarcDefault.tabFavicon;
          ...
          if (!((stateContext.tabs[tabsIndex].url.startsWith('file://') &&
            ...
            stateContext.tabs[tabsIndex].url.startsWith('Monarc:blank'))) {
            ...
            let entry: Monarc.Store.TabHistory | null = null;
            if (index !== -1) {
              ...
              entry = {
                ...
                title: stateContext.tabs[tabsIndex].title,
                url: stateContext.tabs[tabsIndex].url,
                favIconUrl: constants.tabConfig.MonarcDefault.tabFavicon,
                label: dates[0],
                time: dates[1],
              };
            }
  ...
  [types.PAGE_FAVICON_UPDATED](stateContext: Monarc.Store.State, payload: any): void {
    // const windowId: number = payload.windowId;
    const tabId: number = payload.tabId;
    // const tabIndex: number = payload.tabIndex;
    const url: string = payload.url;
  ...
  [types.DID_STOP_LOADING](stateContext: Monarc.Store.State, payload: any): void {
    // const windowId: number = payload.windowId;
    const tabId: number = payload.tabId;
    // const tabIndex: number = payload.tabIndex;
    const url: string = payload.url;
  ...
  [types.DID_FAIL_LOAD](stateContext: Monarc.Store.State, payload: any): void {
    // const windowId: number = payload.windowId;
    const tabId: number = payload.tabId;
    // const tabIndex: number = payload.tabIndex;
  ...
  [types.UPDATE_TARGET_URL](stateContext: Monarc.Store.State, payload: any): void {
    // const windowId: number = payload.windowId;
    const tabId: number = payload.tabId;
    // const tabIndex: number = payload.tabIndex;
    const url: string = payload.url;
  ...
  [types.MEDIA_STARTED_PLAYING](stateContext: Monarc.Store.State, payload: any): void {
    // const windowId: number = payload.windowId;
    const tabId: number = payload.tabId;
    // const tabIndex: number = payload.tabIndex;
  ...
  [types.MEDIA_PAUSED](stateContext: Monarc.Store.State, payload: any): void {
    // const windowId: number = payload.windowId;
    const tabId: number = payload.tabId;
    // const tabIndex: number = payload.tabIndex;
  ...
  [types.TOGGLE_AUDIO](stateContext: Monarc.Store.State, payload: any): void {
    // const windowId: number = payload.windowId;
    const tabId: number = payload.tabId;
    // const tabIndex: number = payload.tabIndex;
  ...
  [types.UPDATE_CERTIFICATE](stateContext: Monarc.Store.State, payload: any): void {
  ...
  [types.UPDATE_EXTENSION_METADATA](stateContext: Monarc.Store.State, payload: any): void {
    const tabId: number = payload.tabId;
  ...
  [types.SET_CURRENT_SEARCH_ENGINE_PROVIDER](stateContext: Monarc.Store.State, { val }: { val: any }): void {
  ...
  [types.SET_HOMEPAGE](stateContext: Monarc.Store.State, { val }: { val: any }): void {
    stateContext.homepage = val.homepage;
  },
  [types.SET_PDF_VIEWER](stateContext: Monarc.Store.State, { val }: { val: any }): void {
    stateContext.pdfViewer = val.pdfViewer;
  },
  [types.SET_TAB_CONFIG](stateContext: Monarc.Store.State, { val }: { val: any }): void {
    Vue.set(stateContext.tabConfig.MonarcDefault, 'tabFavicon', val.tabFavicon);
    Vue.set(stateContext.tabConfig.dummyTabObject, 'url', val.defaultUrl);
  },
  [types.SET_LANG](stateContext: Monarc.Store.State, { val }: { val: any }): void {
    stateContext.lang = val.lang;
  },
  [types.SET_PROXY_CONFIG](stateContext: Monarc.Store.State, { val }: { val: any }): void {
  ...
  [types.SET_AUTH](stateContext: Monarc.Store.State, { val }: { val: any }): void {
    Vue.set(stateContext.auth, 'username', val.username);
    Vue.set(stateContext.auth, 'password', val.password);
  },
  [types.SET_DOWNLOADS](stateContext: Monarc.Store.State, { val }: { val: any }): void {
    stateContext.downloads = val;
  },
  [types.SET_HISTORY](stateContext: Monarc.Store.State, { val }: { val: any }): void {
    stateContext.history = val;
  },
  [types.SET_TABS_ORDER](stateContext: Monarc.Store.State, payload: any): void {
    const windowId: number = payload.windowId;
  ...
  [types.SET_PAGE_ACTION](stateContext: Monarc.Store.State, payload: any): void {
    const tabId: number = payload.tabId;
    // const tabIndex: number = payload.tabIndex;
    const extensionId: string = payload.extensionId;
  ...
  [types.CLEAR_PAGE_ACTION](stateContext: Monarc.Store.State, payload: any): void {
    // const windowId: number = payload.windowId;
    const tabId: number = payload.tabId;
    // const tabIndex: number = payload.tabIndex;
  ...
  // downloads handlers
  [types.CREATE_DOWNLOAD_TASK](stateContext: Monarc.Store.State, payload: any): void {
    stateContext.downloads.unshift(payload);
  },
  [types.UPDATE_DOWNLOADS_PROGRESS](stateContext: Monarc.Store.State, payload: any): void {
    const index =
  ...
  [types.COMPLETE_DOWNLOADS_PROGRESS](stateContext: Monarc.Store.State, payload: any): void {
    const index =
      stateContext.downloads.findIndex(download => (
        download.startTime === payload.startTime
      ));
  ...
  // permissions
  [types.SET_PERMISSIONS](stateContext: Monarc.Store.State, payload: any): void {
    const hostname: string = payload.hostname;
  ...
  // set state
  [types.SET_Monarc_STATE](stateContext: Monarc.Store.State, { newState }: { newState: any }): void {
  ...
  // window state
  [types.CREATE_WINDOW](stateContext: Monarc.Store.State, payload: any): void {
    const windowId: number = payload.windowId;
  ...
  [types.CLOSE_WINDOW](stateContext: Monarc.Store.State, { windowId }: { windowId: number }): void {
  ...
  [types.UPDATE_WINDOW_PROPERTY](stateContext: Monarc.Store.State, payload: any): void {
    const windowId: number = payload.windowId;
    const width: number = payload.width;
    const height: number = payload.height;
    const left: number = payload.left;
  ...
  // extensions
  [types.ADD_EXTENSION](stateContext: Monarc.Store.State, payload: any): void {
  ...
  [types.REMOVE_EXTENSION](stateContext: Monarc.Store.State, payload: any): void {
    const extensionId: string = payload.extensionId;
  ...
  [types.UPDATE_EXTENSION](stateContext: Monarc.Store.State, payload: any): void {
    const enabled: boolean = payload.enabled;
    const extensionId: string = payload.extensionId;
