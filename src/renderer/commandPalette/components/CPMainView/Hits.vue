  ...
  .hit-detail-container
    .hit-detail
      object(v-if="!loading",
             ...
             height='64',
             width='64')
        i(:class="`el-icon-${$store.getters.tabConfig.MonarcDefault.tabFavicon}`",
...
export default class Hits extends Vue {
  highlightedIndex = '';
  suggestions: Monarc.CommandPalette.Suggestion[] = [];
  searchBar: SearchBar | null = null;
  loading = false;
  isOpen = false;

  get lastActiveWindow(): Monarc.Store.MonarcBrowserWindowProperty {
