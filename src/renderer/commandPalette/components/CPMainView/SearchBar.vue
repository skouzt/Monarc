...
export default class SearchBar extends Vue {
  ...
  isComposing = false;
  recommender: any;
  suggestionItems: Monarc.CommandPalette.SuggestionItem[] = config.recommendTopSite;
  ...
  get suggestionItemsByHistory(): any {
    const suggestionItems: Monarc.CommandPalette.SuggestionItem[] = [];
  ...
  unique(suggestions: Monarc.CommandPalette.Suggestion[]): Monarc.CommandPalette.Suggestion[] {
    let suggestionObjects: Monarc.CommandPalette.SuggestionObject[] = [];
  ...
  async querySearch(queryString: string): Promise<void> {
    ...
    const suggestions: Monarc.CommandPalette.Suggestion[] = [];
    let suggestionObjects: Monarc.CommandPalette.SuggestionObject[] = [];
    ...
    const entries: Monarc.CommandPalette.SuggestionObject[][] =
    ...
    suggestions.push({
      ...
      icon: this.$store.getters.tabConfig.MonarcDefault.commandPalette.browsingHistory,
    ...
    suggestions.push({
      ...
      icon: this.$store.getters.tabConfig.MonarcDefault.commandPalette.onlineSearch,
      results: suggestionObjects,
    });
