...
function getMonarcExtUrl(relativeUrl: string): string {
  return `${constants.MonarcPagesCustomProtocol}://${relativeUrl}`;
}

function privilegedUrls(shortCode: string): string {
  switch (shortCode) {
    case 'about:about':
      return getMonarcExtUrl('about/#/');
    case 'about:downloads':
      return getMonarcExtUrl('about/#/downloads');
    case 'about:extensions':
      return getMonarcExtUrl('about/#/extensions');
    case 'about:history':
      return getMonarcExtUrl('about/#/history');
    case 'about:Monarc':
      return getMonarcExtUrl('about/#/Monarc');
    case 'about:preferences':
      return getMonarcExtUrl('about/#/preferences');
    case 'about:blank':
      return 'about:blank';
    case 'about:newtab':
      return getMonarcExtUrl('about/#/newtab');
    case 'about:playbooks':
      return getMonarcExtUrl('playbooks/#/');
    case 'about:gpu':
      return 'chrome://gpu';
    default:
      return getMonarcExtUrl('about/#/');
...
const urlUtil = {
  ...
  isNotURL(input: string): boolean {
    ...
    const case4Reg = /^(data|view-source|mailto|about|Monarc|Monarc-extension|magnet):.*/;
  ...
  /**
   * Gets privileged url from a Monarc scheme
   * @param {string} url
   * @return {object}
   */
  getUrlIfPrivileged(url: string): Monarc.Renderer.AboutLocationObject {
    const pivot = `${constants.MonarcPagesCustomProtocol}://`;
