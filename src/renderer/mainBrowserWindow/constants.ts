...
const homepage = 'https://github.com/MonarcProject/Monarc-browser';
const pdfViewer = 'pdf-viewer';

const tabConfig: Monarc.Store.TabConfig = {
  dummyTabObject: {
    browserViewId: -1,
    webContentsId: -1,
    id: -1,
...
const recommendTopSite: Monarc.Renderer.SuggestionItem[] = [
  {
    title: 'Gmail',
    value: 'gmail.com',
    url: 'gmail.com',
