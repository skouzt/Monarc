...
const websiteNotFound = {
  ...
  message: "Monarc-browser couldn't find this website.",
  secondaryAction: {
...
const sslError = {
  ...
  message: "Monarc-browser couldn't connect securely to this website.",
};
...
const errorCodes = {
  ...
  '-104': {
    message: 'Monarc-browser couldn\'t connect to the website',
  },
  '-105': websiteNotFound,
  '-106': offlineError,
  '-107': sslError,
  ...
  '-200': {
    name: 'This website is not available.',
    message: "Monarc-browser couldn't connect securely to this website. (NET::ERR_CERT_COMMON_NAME_INVALID)",
  },
  '-201': {
    name: 'This website is not available',
    message: "Monarc-browser couldn't connect securely to this website. Please make sure your computer's clock is set correctly.",
  },
  '-202': {
    name: 'This website is not available.',
    message: "Monarc-browser couldn't connect securely to this website. (NET::ERR_CERT_AUTHORITY_INVALID)",
  },
  '-203': sslError,
  '-204': sslError,
  '-205': sslError,
